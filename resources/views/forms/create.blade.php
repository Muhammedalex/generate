...
@section('title', __('forms.create_form'))

@section('content')
<div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-6">{{ __('forms.create_form') }}</h1>
            ...
            <form action="{{ route('forms.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('title_translations.en') }}"
                               required
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('title_translations.ar') }}"
                               class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white">
                ...
                <div class="mb-6">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="description_translations_en" 
                                  ...
                                  rows="3"
                                  class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white">{{ old('description_translations.en') }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea id="description_translations_ar" 
                                  ...
                                  rows="3"
                                  class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white">{{ old('description_translations.ar') }}</textarea>
                ...
                <div class="mb-6">
                    ...
                    <select id="status" 
                            name="status"
                            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white">
                        <option value="draft" {{ old('status', 'draft') === 'draft' ? 'selected' : '' }}>{{ __('forms.draft') }}</option>
                        <option value="published" {{ old('status') === 'published' ? 'selected' : '' }}>{{ __('forms.published') }}</option>
                        <option value="closed" {{ old('status') === 'closed' ? 'selected' : '' }}>{{ __('forms.closed') }}</option>
                    </select>
                    @error('status')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
