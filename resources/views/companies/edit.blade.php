...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-4xl font-bold text-gray-900 dark:text-white mb-2">{{ __('companies.edit_company') }}</h1>
            <p class="text-gray-600 dark:text-gray-400">{{ __('companies.company_details') }}</p>
        </div>

        <form action="{{ route('companies.update', $company) }}" method="POST" enctype="multipart/form-data" class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
            @csrf
            @method('PUT')
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            <input type="color" 
                                   ...
                                   value="{{ old('secondary_color', $company->secondary_color ?? '#8b5cf6') }}"
                                   class="h-10 w-20 border border-gray-300 dark:border-gray-600 rounded-lg cursor-pointer">
                            <input type="text" 
                                   value="{{ old('secondary_color', $company->secondary_color ?? '#8b5cf6') }}"
                                   pattern="^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$"
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            <input type="color" 
                                   id="accent_color" 
                                   name="accent_color" 
                                   value="{{ old('accent_color', $company->accent_color ?? '#ec4899') }}"
                                   class="h-10 w-20 border border-gray-300 dark:border-gray-600 rounded-lg cursor-pointer">
                            <input type="text" 
                                   value="{{ old('accent_color', $company->accent_color ?? '#ec4899') }}"
                                   pattern="^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="url" 
                               ...
                               value="{{ old('social_links.facebook', $company->social_links['facebook'] ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               ...
                               value="{{ old('social_links.twitter', $company->social_links['twitter'] ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               ...
                               value="{{ old('social_links.instagram', $company->social_links['instagram'] ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               ...
                               value="{{ old('social_links.linkedin', $company->social_links['linkedin'] ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               ...
                               value="{{ old('social_links.youtube', $company->social_links['youtube'] ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               ...
                               value="{{ old('social_links.tiktok', $company->social_links['tiktok'] ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               ...
                               value="{{ old('social_links.whatsapp', $company->social_links['whatsapp'] ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               ...
                               value="{{ old('social_links.telegram', $company->social_links['telegram'] ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               ...
                               value="{{ old('social_links.snapchat', $company->social_links['snapchat'] ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               ...
                               value="{{ old('social_links.pinterest', $company->social_links['pinterest'] ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               ...
                               value="{{ old('social_links.reddit', $company->social_links['reddit'] ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               ...
                               value="{{ old('social_links.discord', $company->social_links['discord'] ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               ...
                               value="{{ old('social_links.github', $company->social_links['github'] ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               ...
                               value="{{ old('social_links.behance', $company->social_links['behance'] ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               ...
                               value="{{ old('social_links.dribbble', $company->social_links['dribbble'] ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               ...
                               value="{{ old('social_links.medium', $company->social_links['medium'] ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               ...
                               value="{{ old('social_links.vimeo', $company->social_links['vimeo'] ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               ...
                               value="{{ old('social_links.twitch', $company->social_links['twitch'] ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               ...
                               value="{{ old('social_links.soundcloud', $company->social_links['soundcloud'] ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               ...
                               value="{{ old('social_links.spotify', $company->social_links['spotify'] ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               ...
                               value="{{ old('social_links.apple_music', $company->social_links['apple_music'] ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               ...
                               value="{{ old('social_links.xing', $company->social_links['xing'] ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               ...
                               value="{{ old('social_links.vk', $company->social_links['vk'] ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               ...
                               value="{{ old('social_links.wechat', $company->social_links['wechat'] ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               ...
                               value="{{ old('social_links.weibo', $company->social_links['weibo'] ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               ...
                               value="{{ old('social_links.line', $company->social_links['line'] ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="url" 
                               ...
                               value="{{ old('social_links.skype', $company->social_links['skype'] ?? '') }}"
